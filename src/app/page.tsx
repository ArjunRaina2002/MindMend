...
import { Brain, MessageCircle, BarChart2, Users } from 'lucide-react'
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        <Card className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
          ...
          <CardContent>
            <CardDescription className="m-0 max-w-[30ch] text-sm opacity-50">
              Experience personalized AI-driven therapy sessions.
            </CardDescription>
          </CardContent>
          <CardFooter>
            <Button asChild>
        ...
        <Card className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
          <CardHeader>
            <CardTitle className="mb-3 text-2xl font-semibold">
              <MessageCircle className="h-6 w-6 inline-block mr-2" />
              Chat Support
            </CardTitle>
          </CardHeader>
          <CardContent>
            <CardDescription className="m-0 max-w-[30ch] text-sm opacity-50">
              Connect with our AI chatbot for instant support.
            </CardDescription>
          </CardContent>
          <CardFooter>
            <Button asChild>
        ...
        <Card className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
          ...
          <CardContent>
            <CardDescription className="m-0 max-w-[30ch] text-sm opacity-50">
              Join our supportive community and share experiences.
            </CardDescription>
          </CardContent>
          <CardFooter>
            <Button asChild>
